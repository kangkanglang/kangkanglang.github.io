...
内存模型如下图所示：
![Java内存模型](imagesMD/Java-GC小结/java内存模型.png)
...
![Java GC过程](imagesMD/Java-GC小结/javaGC过程.png)
...
![所有GC算法](imagesMD/Java-GC小结/allGC算法.png)
...
![Serial模型](imagesMD/Java-GC小结/Serial.png)
...
![Parallel Scaven模型](imagesMD/Java-GC小结/ParallelScaven.png)
...
![Serial Old模型](imagesMD/Java-GC小结/SerialOld.png)
...
![ParNew模型](imagesMD/Java-GC小结/ParNew.png)